...
function Sidebar() {
  ...
  return (
    <SideBar>
      ...
      <div className="dataInSection">
        ...
        <DropdownContainer>
          ...
          <DropdownSelect value={selectedOption} onChange={handleChange}>
            <DropdownOption value="Energy">{selectedOption}</DropdownOption>
            <DropdownOption value="Energy">Category 1</DropdownOption>
            <DropdownOption value="Energy">Category 2</DropdownOption>
            <DropdownOption value="Energy">Category 3</DropdownOption>
            <DropdownOption value="Energy">Category 4</DropdownOption>
          </DropdownSelect>
          <DropdownArrow
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <div className="secondSection button" style={{ paddingLeft: "16px" }}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
      ...
      <LastDiv className="bottomSection">
        <div className="content">
          <p>POWERED BY</p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
...
const SideBar = styled.div`
  ...
  .logoImg {
    ...
    img {
      ...
      height: 47px;
      flex-shrink: 0;
      /* background: url(logo), lightgray 50% / cover no-repeat; */
    }
  }
